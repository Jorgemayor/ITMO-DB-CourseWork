...
INSERT INTO teams (id, id_trainer, id_format, name, private) VALUES
	(1, 1, 1, 'Raining team', FALSE),
	(2, 1, 2, 'Trick room team', TRUE),
	(3, 2, 1, 'All offensive team', TRUE),
	(4, 2, 2, 'Water type team', FALSE),
	(5, 3, 1, 'Champion''s team', FALSE),
	(6, 3, 2, 'Stall team', FALSE)
;
