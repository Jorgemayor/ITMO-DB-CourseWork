...
(
	id		SERIAL	PRIMARY KEY,
	id_trainer	INT	NOT NULL	REFERENCES trainers	ON DELETE CASCADE ON UPDATE CASCADE,
	id_format	INT	NOT NULL	REFERENCES formats	ON DELETE CASCADE ON UPDATE CASCADE,
	name		TEXT	NOT NULL,
...
(
	...
	id_format	SERIAL		NOT NULL	REFERENCES formats	ON DELETE CASCADE ON UPDATE CASCADE
);
